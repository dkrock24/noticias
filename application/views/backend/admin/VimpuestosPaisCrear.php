  ...
  $(document).ready(function(){
      // CONVERTIR FECHAS A TEXTO
        ...
        $("#guardar").click(function(){
            $.ajax({
            url: "../admin/Cimpuesto/saveImpuestoPais/",  
            type: "post",
            ...
            <form action="#" method="POST" name="impuesto" id="crearImpuesto">
                <div class="list-group">
                    <a href="#" class="list-group-item active">
                        <i class='fa fa-info'></i>Crear Nuevo Impuesto para Pais<i id="back" class="fa fa-arrow-left" name="../admin/Cimpuesto/index" alt="Atras"></i>
                    </a>
