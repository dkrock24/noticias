  ...
  $(document).ready(function(){
      // CONVERTIR FECHAS A TEXTO
        ...
        $("#guardar").click(function(){
        	$.ajax({
            url: "../admin/Csucursales/saveNodo/",  
            type: "post",
			...
			<form action="#" method="POST" name="sucursal" id="crearSucursal">
				<div class="list-group">
				 	<a href="#" class="list-group-item active">
				    	<i class='fa fa-home'></i>Crear Nuevo Nodo
				  	</a>
				  	...
				  	<a  class="list-group-item">
				  		<td>Categoria :</td>
				  		<td> <input type="text" class="form-control" name="categoria" value=""></td>
				  	</a>
				  	<a  class="list-group-item">
				  		<td>URL :</td>
				  		<td> <input type="text" class="form-control" name="url" value=""></td>
				  	</a>				  	
				  	<a  class="list-group-item">
				  		<td>Estado :</td>
				  		<td> 
